...
public class RabbitMessageListener {
  ...
  public RabbitMessageListener(MessageProcessor processor,ShutdownHandler shutdownHandler,
  ...
  @SneakyThrows
  @RabbitListener(queues = RabbitConfig.WORKER_QUEUE_NAME, exclusive = true)
  void onMessage(Message message, Channel channel, @Header(AmqpHeaders.DELIVERY_TAG) long deliveryTag) {
